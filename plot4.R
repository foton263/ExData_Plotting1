...
with(disrange, {
  plot(Global_active_power~as.POSIXct(disrange$date_time), type="l",
       ylab="Global Active Power (kilowatts)", xlab="")
  plot(Voltage~as.POSIXct(disrange$date_time), type="l",
       ylab="Voltage", xlab="datetime")
  plot(Sub_metering_1~as.POSIXct(disrange$date_time), type="l",
       ylab="Energy sub metering", xlab="")
  lines(Sub_metering_2~as.POSIXct(disrange$date_time),col='Red')
  lines(Sub_metering_3~as.POSIXct(disrange$date_time),col='Blue')
  legend("topright", col=c("black", "red", "blue"), lty=1, lwd=2, bty="n",
         legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
  plot(Global_reactive_power~as.POSIXct(disrange$date_time), type="l",
       ylab="Global_Reactive Power",xlab="datetime")
})
# define output call open the device plot and close it!
destplot<-paste(workdir,"/","plot4.png",sep = "")
